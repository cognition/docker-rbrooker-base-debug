...
RUN apt-get update ; apt-get -y install logrotate wget apt-utils apt-transport-https bash-completion vim net-tools ; apt-get -y upgrade

ADD /src/bashrc /root/.bashrc 
